from __future__ import annotationsimport osfrom dataclasses import asdict, dataclass, fieldfrom typing import Any@dataclassclass LocalExchangeSettings:    enabled: bool = False    api_key: str = ""    secret_key: str = ""@dataclassclass LocalSignalSettings:    server_ws_url: str = ""    server_http_url: str = ""    last_signal_id: int = 0@dataclassclass LocalTradingSettings:    default_volume: float = 10.0    default_leverage: int = 1    default_direction: str = "long"    auto_trading_enabled: bool = False    auto_trading_enabled_at: str = ""    use_min_volume: bool = False    auto_order_usdt: float = 10.0    auto_leverage_enabled: bool = True    max_auto_leverage: int = 20    disable_signal_filters: bool = False    ignore_min_usd_by_market_share: bool = False    min_usd_override_twap_share_percent: float = 1.0@dataclassclass LocalSettings:    selected_exchange: str = "binance"    exchanges: dict[str, LocalExchangeSettings] = field(        default_factory=lambda: {"binance": LocalExchangeSettings()}    )    trading: LocalTradingSettings = field(default_factory=LocalTradingSettings)    signals: LocalSignalSettings = field(default_factory=LocalSignalSettings)    def to_dict(self, hide_secrets: bool = False) -> dict[str, Any]:
        data = asdict(self)
        if hide_secrets:
